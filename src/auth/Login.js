    ...
    onClickLogin () {
        if (this.state.email !== '') {
            if (this.state.password !== '') {
                ...
                this.setState({
                    errors: { ...this.state.errors, password: 'please enter password' }
                });
            }
        } else {
            this.setState({
                errors: { ...this.state.errors, email: 'please enter email' }
            });
        }
    }
                          ...
                          <div className="login_block">
                              <div className="login_form_block">
                                  ...
                                  <form method="post" action="">
                                    ...
                                    <div className="forgot">Forgot Password <a href="/app/password-reset" onClick={() => this.props.history.push('/password-reset')}>Click Here?</a></div>
                                    <button type="button" onClick={() => this.onClickLogin()}  className="btn btn-warning text-white">Login</button>
                                  </form>                                  
                                </div>
                            </div>
                        </div>
