                ...
                <Typography sx={{ mt: 0, textTransform: "lowercase", fontSize: "15px", color: "#1A3353" }}> 
                  {
                    ...
                    `${ closeOffset + 1 } to
                      ...
                      closeOffset + 10 ? closeOffset + 10 : 0 }`
                  }
                </Typography>
      ...
      <div>
        <TabPanel value={ value } index={ 0 }>
          <Box sx={{ width: '100%', mt: 3 }}>
                              ...
                              <TableRow
                                ...
                                <TableCell align="left"
                                  ...
                                  <div style={{ display: "flex" }}>
                                    {
                                      item.tags && item.tags.length > 0 ? item.tags.map((tagData) => (
                                      <Tags tags={ tagData }/>
                                      )) : "--"
                                    }
                                  </div>
            ...
            {
              isDelete ? <DeleteAccount deleteItemId={ deleteItemId } isDelete={ isDelete }
                onClose={ onclose }
                onDelete={ onDelete }
              /> : " "
            }
              ...
              <TableContainer>
                <Table
                  ...
                  <EnhancedTableHead
                    ...
                    onSelectAllClick={ handleSelectAllClick }
                    onRequestSort={ handleRequestSort }
                    rowCount={ value === 0 ? accountData.accountLength
                  ...
                  <TableBody>
                    {
                      value !== 0 && accountData && accountData.close_accounts ? accountData.close_accounts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, index) => {
                        const isItemSelected = isSelected(item.name);
                        const labelId = `enhanced-table-checkbox-${ index }`;
                        return (
                          <TableRow
                            ...
                            <TableCell align="left"
                              sx={{ border: 0, color: "rgb(26, 51, 83)" }}>
                              { item.website ? item.website : "--" }</TableCell>
                            <TableCell align="left" sx={{ border: 0, color: "rgb(26, 51, 83)" }}>
                              {
                                item && item.created_by ?
                                  <UserDetails created_by={ item.created_by } /> : "--"
