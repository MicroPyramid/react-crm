...
export const AddAccount = (props) => {
  ...
  const validatation = () => {
    ...
    if (!(Object.prototype.hasOwnProperty.call(val, 'name')) || val.name === '') {
      ...
      setMsg('name')
    } else if (!(Object.prototype.hasOwnProperty.call(val, 'website')) || val.website === '') {
      setError('*required field')
      setMsg('website')
      flag = false
      ...
      setMsg('email')
      flag = false
    } else if (!(Object.prototype.hasOwnProperty.call(val, 'organization')) || val.organization === '') {
      setError('*required field')
      setMsg('organization')
      flag = false
                  ...
                  >
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        ...
                        style={{ width: '70%' }}
                        size='small'
                        required={!!(msg === 'organization' || msg === 'required')}
                        helperText={
