...
export function AddLeads () {
  ...
  const validatation = () => {
    ...
    if (!(Object.prototype.hasOwnProperty.call(val, 'title')) || val.title === '') {
      ...
      setMsg('title')
    } else if (!(Object.prototype.hasOwnProperty.call(val, 'opportunity_amount')) || val.opportunity_amount === '') {
      flag = false
      setError('*required amount field')
      setMsg('opportunity_amount')
    } else if (!(Object.prototype.hasOwnProperty.call(val, 'first_name')) || val.first_name === '') {
      ...
      const validEmail = isEmail(val.email)
      if (validEmail === false) {
                ...
                >
                  <div className='fieldContainer'>
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        ...
                        style={{ width: '80%' }}
                        size='small'
                        required={!!(msg === 'title' || msg === 'required')}
                        helperText={
                    ...
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        ...
                        style={{ width: '80%' }}
                        size='small'
                        required={!!(msg === 'opportunity_amount' || msg === 'required')}
                        helperText={
                  ...
                  <div className='fieldContainer2'>
                    ...
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        error={!!(msg === 'company' || msg === 'required')}
                        name='company'
                        id='outlined-error-helper-text'
                        onChange={onChange}
                        InputProps={{
                    ...
                    <div className='fieldSubContainer'>
                      ...
                      >
                        ...
                        <Select
                          ...
                          name='industry'
                          size='small'
                          required={!!(msg === 'industry' || msg === 'required')}
                          helperText={
                            (error && msg === 'industry') || msg === 'required'
                              ? error
                              : ''
                  ...
                  <div className='fieldContainer2'>
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        ...
                        required={!!(msg === 'account_name' || msg === 'required')}
                        onChange={onChange} style={{ width: '80%' }}
                        size='small'
                        helperText={
                          (error && msg === 'account_name') || msg === 'required'
                ...
                >
                  ...
                  <div className='fieldContainer2'>
                    ...
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        name='phone'
                        error={!!(msg === 'phone' || msg === 'required' || errors.phone)}
                        id='outlined-error-helper-text'
                        onChange={onChange}
                        style={{ width: '80%' }}
                        InputProps={{
