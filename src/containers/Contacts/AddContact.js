                ...
                >
                  ...
                  <div className='fieldContainer2'>
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        error={msg === 'primary_email'}
                        required={!!(msg === 'primary_email' || msg === 'required')}
                        name='primary_email'
                        id='outlined-error-helper-text'
                        onChange={onChange}
                        InputProps={{
                  ...
                  <div className='fieldContainer2'>
                    <div className='fieldSubContainer'>
                      ...
                      <TextField
                        error={!!(msg === 'department' || msg === 'required')}
                        name='department'
                        id='outlined-error-helper-text'
                        onChange={onChange}
                        InputProps={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', marginTop: '20px' }}>
                    <div style={{ width: '40%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <TextField
                        ...
                        style={{ width: '70%' }}
                        size='small'
                        required={!!(msg === 'postcode' || msg === 'required')}
                        helperText={
                    ...
                    <div style={{ width: '40%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <TextField
                        ...
                        style={{ width: '70%' }}
                        size='small'
                        required={!!(msg === 'country' || msg === 'required')}
                        helperText={
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }}>
                    <div style={{ width: '40%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <TextField
                        ...
                        style={{ width: '70%' }}
                        size='small'
                        required={!!(msg === 'linked_in_url' || msg === 'required')}
                        helperText={
