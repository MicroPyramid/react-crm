                  ...
                  <div className="fieldContainer"
                    ...
                    <div className="fieldSubContainer">
                      ...
                      <TextField
                        ...
                        id="outlined-error-helper-text"
                        onChange={onChange}
                        defaultValue={state.opportunities && state.opportunities.contacts ? state.opportunities.contacts : ""}
                        InputProps={{
                          classes: {
                    ...
                    <div className="fieldSubContainer">
                      ...
                      <FormControl sx={{
                        ...
                        <Select
                          ...
                          name="status"
                          size="small"
                          defaultValue={state.opportunities && state.opportunities.status}
                          onChange={onChange}
                          MenuProps={MenuProps}
                          InputProps={{
                            classes: {
                    ...
                    <div className="fieldSubContainer">
                      ...
                      <FormControl sx={{ width: "70%" }}>
                        ...
                        <Select
                          ...
                          name="priority"
                          size="small"
                          value={state.opportunities && state.opportunities.priority}
                          onChange={onChange}
                          MenuProps={MenuProps}>
                          {
                    ...
                    <div className="fieldSubContainer">
                      ...
                      <FormControl sx={{ width: "70%" }}>
                        ...
                        <Select
                          ...
                          name="case_type"
                          size="small"
                          value={state.opportunities && state.opportunities.case_type}
                          onChange={onChange}
                          MenuProps={MenuProps}>
                          {
