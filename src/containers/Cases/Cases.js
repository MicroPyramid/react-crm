          ...
          <Card >
            <TableContainer component={Paper}>
              <Table aria-label="customized table">
                ...
                <TableBody >
                  {
                    casesData.cases && casesData.cases ? stableSort(casesData.cases && casesData.cases, getComparator(order, orderBy)).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, index) => (
            ...
            {
              isDelete ? <DeleteCases casesId={casesId} isDelete={isDelete}
                onClose={onclose}
                onDelete={onDelete}
              /> : ""
            }
