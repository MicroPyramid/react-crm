...
import LeadInformation from '../leads/createLead/LeadInformation'
import ContactInformation from '../leads/createLead/ContactInformation'
import AddressInformation from '../leads/createLead/AddressInformation'
import Description from '../leads/createLead/Description'
                ...
                <div style={{ backgroundColor: "#1A3353" }} className="p-2 d-flex justify-content-between">
                    <div>
                        <Breadcrumb style={{ color: "white" }}>
                            ...
                            <Breadcrumb.Item>
                                <a href="!#" style={{ color: "white" }}> Edit Lead</a>
                            </Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                    <div className="mr-3">
