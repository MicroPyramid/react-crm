...
export default function DeleteActionButton (props) {
  ...
  const deleteObject = (e) => {
    ...
    return (
        ...
        <a            
            href={`${to}`}
            className="action__btn-delete-a delete remove_account"
            title="Delete"
            onClick={(e) => deleteObject(e)}
        >
            <svg
                className="action__btn action__btn-delete svg-inline--fa fa-trash-alt fa-w-14 svg-size"
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
                data-icon="trash-alt"
