...
export default function MailActionButton({lead, to}) {
  
  return (    
      <a href={`/${to}/create-mail`} className="action__btn-email-a mr-1" title="View" data-account={lead.id} data-account-email={lead.email}  title="Send Mail" data-toggle="modal" data-target="#send_email_to_contacts">
