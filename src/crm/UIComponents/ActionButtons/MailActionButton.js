...
export default function MailActionButton({object, to}) {
  
  return (    
      <a href={`/${to}/create-mail`} className="action__btn-email-a mr-1" title="View" data-account={object.id} data-account-email={object.email}  title="Send Mail" data-toggle="modal" data-target="#send_email_to_contacts">
